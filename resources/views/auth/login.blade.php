          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <span class="h1 fw-bold mb-0">Ingreso de sesion</span>
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">Ingresa para registrarte <a href="{{route('register')}}"
                      style="color: #393f81;">Registro</a></p>
